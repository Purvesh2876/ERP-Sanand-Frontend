...
import { createCamera, getCustomerCameraList, updateCamera, deleteCamera, getBox, createBox, deleteShelf, getShelf, createShelf, getRack, createRack, deleteRack } from '@/pages/api/getcamera';
...
const RackList = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      ...
      const response = await createRack(formObject);
